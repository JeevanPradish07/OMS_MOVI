        ...
        <div className="space-y-10 divide-y divide-[#E2E8F0]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-2">
            ...
            <div className="lg:col-span-2 bg-white border border-[#E2E8F0] rounded-xl shadow-sm p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-[13px] font-medium text-[#0F172A] mb-1.5">Employee ID <span className="text-[#DC2626]">*</span></label>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-10">
            ...
            <div className="lg:col-span-2 bg-white border border-[#E2E8F0] rounded-xl shadow-sm p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-[13px] font-medium text-[#0F172A] mb-1.5">Permission Template</label>
                  <div className="relative">
                    <select className="w-full border border-[#E2E8F0] rounded-lg px-3.5 py-2.5 text-[14px] bg-white focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB] transition-colors appearance-none cursor-pointer">
              ...
              <div className="pt-4 border-t border-[#E2E8F0]">
                ...
                <div className="space-y-3">
                  <label className="flex items-start gap-3 cursor-pointer group">
                    ...
                    <div>
                      <span className="block text-[13px] font-medium text-[#0F172A] group-hover:text-[#2563EB] transition-colors">Generate Temporary Password</span>
                      <span className="block text-[12px] text-[#64748B]">System will automatically generate a secure 12-character password.</span>
                    </div>
                  </label>
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <div className="relative flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="block text-[13px] font-medium text-[#0F172A] group-hover:text-[#2563EB] transition-colors">Send Invitation Email</span>
                      <span className="block text-[12px] text-[#64748B]">User will receive instructions on how to log in.</span>
                    </div>
                  </label>
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <div className="relative flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="block text-[13px] font-medium text-[#0F172A] group-hover:text-[#2563EB] transition-colors">Require Password Change</span>
                      <span className="block text-[12px] text-[#64748B]">User must change their password upon first login.</span>
                    </div>
                  </label>
                </div>
              </div>
